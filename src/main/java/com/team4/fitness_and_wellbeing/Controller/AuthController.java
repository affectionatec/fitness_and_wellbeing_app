...
import com.team4.fitness_and_wellbeing.model.AuthenticationResponse;
...
import com.team4.fitness_and_wellbeing.utils.Sendmail;
...
public class AuthController {
    ...
    public ResponseEntity<?> createAuthenticationToken(@RequestBody AuthenticationRequest authenticationRequest) throws Exception {
        ...
        Client.clientArrayList = new ArrayList<>();
        Client.populateList();
    ...
    //for seperating console (maybe idk)
